        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Officers List - <span style="color: #f9a602;font-weight:600;"> SENIOR OFFICERS </span></h3>
              <nav aria-label="breadcrumb">
                     <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-info create-new-button" id="createbuttonDropdown" 
                data-bs-toggle="dropdown" aria-expanded="false" href="#"><<< Select Rank >>></a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                 aria-labelledby="createbuttonDropdown" style="width: 300px;">
                  <h6 class="p-3 mb-0">Ranks</h6>
                  <div class="dropdown-divider"></div>
                  <a href="senior-officers<" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Senior officers</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="chief-inspectors" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Chief Inspectors</p>
                    </div>
                  </a>    
                  <div class="dropdown-divider"></div>
                  <a href="inspectors" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Inspectors</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="sergeants" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Sergeant</p>
                    </div>
                  </a>
                   <div class="dropdown-divider"></div>
                  <a href="corporals" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Corporal</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="lance-corporals" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Lance Corporal</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a href="constables" class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                    </div>
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1">Constables</p>
                    </div>
                  </a>
                </div>
              </li>
                  ...
                  <?php
                      ...
                      while ($row = mysqli_fetch_array($query)) {
                        ...
                        $_SESSION['armourer_admin_name'] = $armourer_admin_name;
                          ...
                          $query = mysqli_query($connect_db,"SELECT * FROM `officers` WHERE `rank` NOT IN ('CONST', 'L/CPL', 'CPL', 'SGT', 'INSPR', 'C/INSPR') AND `officer_status`='Active' OR `rank` NOT IN ('CONST', 'L/CPL', 'CPL', 'SGT', 'INSPR', 'C/INSPR') AND `officer_status`='Active In Service' ORDER BY `officerID` ASC")
                          or die( mysqli_error($connect_db));
                          while ($row = mysqli_fetch_array($query)) {
                              $output = "";
