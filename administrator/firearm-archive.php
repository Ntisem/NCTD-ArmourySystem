...
<head>
    <meta charset="UTF-8">
    <title>TERMINAL | WEAPON_RECOVERY</title>
    ...
    <div class="container-fluid p-4">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="text-cyan mb-0">[ WEAPON_RECYCLE_BIN ]</h4>
                ...
                <div class="table-responsive">
                    <table id="recoveryTable" class="table table-dark table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><?= $asset['firearm_serial_no'] ?></td>
                                <td><?= $asset['manufacturer'] ?></td>
                                <td><?= $asset['firearm_name'] ?></td>
                                <td><?= $asset['datetime'] ?></td>
                                <td>
                                    <button class="btn btn-outline-success btn-xs" onclick="triggerRestore('<?= $asset['firearmID'] ?>', '<?= $asset['firearm_serial_no'] ?>')">REDEPLOY</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="container-fluid">
        <div class="d-sm-flex justify-content-center justify-content-sm-between align-items-center">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center" style="color: #6c7293; font-size: 0.8rem; font-family: 'JetBrains Mono', monospace;">
                DEV: <span style="">C/INSPR W. NTISEM</span> | &copy; <?php echo date("Y"); ?>
            </span>
        </div>
    </div>
</footer>
