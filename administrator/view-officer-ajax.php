...
if (isset($_GET['id'])) {
    ...
    if ($off) {
        ...
        if (!empty($off['officer_image']) && file_exists('assets/images/officer_images/' . $off['officer_image'])) {
            echo '<img src="assets/images/officer_images/' . $off['officer_image'] . '" class="rounded-circle border border-info" width="100" height="100">';
        } else {
