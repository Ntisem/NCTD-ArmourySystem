      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title">Firearm Returns History </h3>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="not-returns-firearms"><code><i class="mdi mdi-history f-22 text-red" 
                    data-toggle="tooltip" data-placement="right" title="Not Return Firearms Bookings"></i></code></a>
                    </p>
                  ...
                  <thead>
                     ...
                     <?php
                         ...
                         while ($row = mysqli_fetch_array($query)) {
                          ...
                          $query = mysqli_query($connect_db,"SELECT * FROM `bookings` WHERE `returns` = 'Returned' ORDER BY `bookingID` ASC")
