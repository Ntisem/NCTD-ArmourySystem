...
<html lang="en">
  <head>
    ...
    <title>GPS ARMOURY SYSTEM - ASSETS</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="add-new-other-assets"><code><i class="mdi mdi-plus f-22 text-green"></i><i class="mdi mdi-keg f-22 text-green" 
                    data-toggle="tooltip" data-placement="right" title="Click to Add New Asset"></i></code></a>
                    </p>
