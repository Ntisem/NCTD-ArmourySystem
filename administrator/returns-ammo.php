        ...
        <div class="main-panel">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="not-returns-ammo"><code><i class="mdi mdi-history f-22 text-red" 
                    data-toggle="tooltip" data-placement="right" title="Not Return Ammo Bookings"></i></code></a>
                    </p>
                <table id="administrators-list" class="table table-bordered ">
                  <thead>
                     ...
                     <?php
                          ...
                          WHERE `ammo_returns` = 'Returned' ORDER BY `book_ammoID` ASC")
