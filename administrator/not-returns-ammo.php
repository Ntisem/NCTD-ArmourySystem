      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title">Ammo Not Returns History </h3>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="returns-ammo"><code><i class="mdi mdi-history f-22 text-green" 
                    data-toggle="tooltip" data-placement="right" title="Return Ammo Bookings"></i></code></a>
                    </p>
                <table id="administrators-list" class="table table-bordered ">
                  <thead>
                     ...
                     <?php
                          ...
                          $query = mysqli_query($connect_db,"SELECT *  FROM `ammo_bookings` 
                          WHERE `ammo_returns` = 'Not-Return' ORDER BY `book_ammoID` ASC")
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            <td>
                            <a href="#booking-ammo-details-'.$row['book_ammoID'].'" data-toggle="modal" style="text-decoration:none;color:#fff;">
                            <img src="assets/images/officer_images/'.$row['officer_image'].'" alt="image" /> 
                              '.$row['to_officer'].'</a> 
                            </td>
                  
                            <td>'.$row['ammo_name'].'</td>
                            <td> <strong><code>['.$row['ammo_rounds'].']</code></strong></td>
                            <td>
                            <a href="#return-ammo-'.$row['book_ammoID'].'&'.$row['officerID'].'"  
                          ...
                          <td>'.$row['ammo_name'].'</td>
                          <td><strong><code> ['.$row['ammo_rounds'].']</code> <code style="color:green"> ['.$row['ammo_returned'].']</code></strong></td>
                          <td>
                          <a href="#" 
                            class=" btn-outline-success" style="padding-top:6px;text-decoration:none;">[ '.$row['ammo_returns'].' ]</a>   
                          </td>
                          <td> '.$row['duty_type'].' @ '.$row['duty_location'].' </td>
                          <td> 
                          <a href="#edit-return-ammo-'.$row['officerID'].'&'.$row['book_ammoID'].'" data-toggle="modal"><i class="mdi mdi-playlist-edit f-16 mr-15 text-green"></i></a>
                        ...
                        include('returning-not-ammo-modal.php');
