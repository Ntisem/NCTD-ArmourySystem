      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title">Assets Not Returns History </h3>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="returns-assets"><code><i class="mdi mdi-history f-22 text-green" 
                    data-toggle="tooltip" data-placement="right" title="Return Assets Bookings"></i></code></a>
                    </p>
                  ...
                  <thead>
                     ...
                     <?php
                          ...
                          $query = mysqli_query($connect_db,"SELECT * FROM `asset_bookings` WHERE 
                           `asset_returns` = 'Not-Return' ORDER BY `bookAssetID` ASC")
                          ...
                          ';
                           ...
                           include('returning-not-asset-modal.php');
