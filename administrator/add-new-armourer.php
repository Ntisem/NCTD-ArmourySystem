...
<html lang="en">
  <head>
    ...
    <title>GPS ARMOURY SYSTEM - ADD NEW ARMOURER</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add New Armourer </h3>
                    ...
                    <!-- <h4 class="card-title">Horizontal Two column</h4> -->
                      ...
                      <!-- <p class="card-description"> Personal info </p> -->
                          ...
                          <option value="Female">Female</option>
                            ...
                            <div class="form-group">
                            <label class="labs" for="exampleInputEmail3"><code style="color:#fff"> User Status</code> </label>
                            </div>  
                            <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="profile_image" id="profile_image" id="exampleFormControlFile1">
                          ...
                          <button type="submit" name="add_armourer" class="btn btn-inverse-success me-2">Submit</button>
