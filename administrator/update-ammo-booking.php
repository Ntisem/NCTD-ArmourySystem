...
?>
 <?php
  $ammo_booking_ticket=$_GET['ammo-booking-ticket'];

  $query = mysqli_query($connect_db,"SELECT * FROM `ammo_bookings` WHERE  book_ammoID='$ammo_booking_ticket'")
  ...
  $ammo_booking_ticket = $row['book_ammoID'];
  $_SESSION['book_ammoID'] = $ammo_booking_ticket;
  $ammo_name =$row['ammo_name'];
  $_SESSION['ammo_name'] = $ammo_name;
                ...
                <div class="card">
                  <div class="card-body">
                    <form class="form-sample" method="POST" action="functions.php" enctype="multipart/form-data">
                      <h2 class="btn btn-inverse-primary btn-fw"> <?php echo $ammo_returns; ?>  </h2>
                      <br>
                      <br>
                      <hr>
                      <div class="row">
                        ...
                        <?php  
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                              ...
                              <input type="hidden" name="book_ammoID" class="form-control" id="exampleInputName1" value="<?php echo $ammo_booking_ticket; ?>">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <input  type="hidden"  name="ammo_returns" class="form-control" value="<?php echo $ammo_returns; ?>" />
                      ...
                      <p class="card-description">Ammunition Details</p>
                       <div class="row">
                        ...
                        <div class="col-md-12">
                        <div class="form-group">
                        <label class="col-sm-5 col-form-label" for="exampleTextarea1"><code style="color:#fff">Number of Rounds</code></label>
                        <input type="text" name="ammo_rounds" class="form-control" value="<?php echo $ammo_rounds ?>"/>
                         </div>
                       </div>
                      </div>
                       <hr>
                       ...
                       <div class="row">
                        ...
                        <div class="col-xl-10">
                          <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                            <textarea style="height:150px" name="ammo_comment" id="comment" value="<?php echo $ammo_comment ?>"
                      ...
                      <hr>
                      <button type="submit" name="update-ammo-booking-ticket" class="btn btn-inverse-success btn-fw f-20 me-2">Submit</button>
                      <a href="booked-ammo" class="btn btn-inverse-danger f-20 btn-fw">Cancel</a>
                    </form>
                  </div>
                </div>
              </div>
