...
<!-- Returns Ammo  Modal -->
<div class="modal fade" id="return-ammo-<?php echo $row['book_ammoID'];?>&<?php echo $row['officerID'];?>" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-light btn-fw" name="not-returning-ammo">Submit</button>
      </div>
      </form>
    </div>
  </div>
