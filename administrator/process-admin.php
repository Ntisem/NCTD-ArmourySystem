...
if (isset($_POST['add_admin'])) {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0) {
        ...
        if (in_array($ext, $allowed)) {
            ...
            if (!is_dir('assets/images/admin_images')) {
                mkdir('assets/images/admin_images', 0755, true);
            }
            move_uploaded_file($_FILES['profile_image']['tmp_name'], 'assets/images/admin_images/' . $new_filename);
