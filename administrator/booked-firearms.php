...
<html lang="en">
  <head>
    ...
    <title>GPS ARMOURY SYSTEM - FIREARMS BOOKING HISTORY</title>
    <!-- plugins:css -->
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title"> Booked Firearms </h3>
              <h3 class="page-title"><code><a href="booked-firearms" class="btn btn-outline-danger btn-fw"> [ Booked Firearm ]</a>
          ...
          <div class="col-12">
            <div class="card">
              ...
              data-toggle="tooltip" data-placement="right" title="Click to Book for Firearm"></i></code></a></p>
                     ...
                     <?php
                      ...
                      while ($row = mysqli_fetch_array($query)) {
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            data-toggle="modal" class="badge badge-outline-primary" style="padding-top:6px;text-decoration:none;"> '.$row['returns'].' </a>         
                            </td>
                          ...
                          <td>'.$row['firearm_name'].'</td>
                          <td><strong><code>[BAR: '.$row['number_of_rounds'].' ]</code><code style="color:orange">[RAR: '.$row['ammo_returned'].']</code></strong></td>
                          <td>
                        ...
                        include('returning-firearm-modal.php');
