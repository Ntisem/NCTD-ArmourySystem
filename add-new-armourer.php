...
<head>
    <meta charset="utf-8">
    <title>COMMAND_TERMINAL | ADD_NEW_ARMOURER</title>
...
<body>
            ...
            <div class="row flex-grow justify-content-center">
                <div class="col-lg-10"> 
                   <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="armourers" class="btn btn-outline-secondary btn-sm" style="border-radius:0;"><i class="mdi mdi-arrow-left-bold"></i>BACK</a>
                    </div>
                    <div class="card tactical-card">
                        <div class="card-body p-5"> 
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h3 style="font-family: 'Orbitron'; color: #fff; margin:0;">[ REGISTER_NEW_ARMOURER ]</h3>
    ...
    <script>
        ...
        $('#armourerForm').on('submit', function(e) {
