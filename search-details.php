...
<html lang="en">
  <head>
    ...
    <title>GPS ARMOURY SYSTEM - SEARCH DETAILS</title>
    <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    if(isset($_GET['firearmID']) && $_GET['firearmID']>0 && isset($_GET['firearm_serial_no'])
                     && $_GET['firearm_serial_no']!=''){
                        ...
                        $sql="SELECT * FROM `firearms` WHERE `firearmID` ='$firearmID' AND `firearm_serial_no` 
                              ='$firearm_serial_no'";

                        $search_result=mysqli_query($connect_db,$sql)
                              ...
                              <div class="card">
                                ...
                                <a href="firearm-bookings-under?firearmID='.$row['firearmID'].'" type="button" class="btn btn-primary btn-lg btn-block" style="margin-bottom:30px;">
                                 <i class="mdi mdi-book"></i> Bookings</a>
                                  <p class="card-description">Weapon No.<code>'.$row['weapon_number'].'</code>
                                  </p>
                                  <div class="table-responsive">
                                    <table class="table">
                                      ...
                                      <tr>
                                      <td></td>
                                      <td><a href="search"><button type="button" class="btn btn-outline-danger btn-fw"> <i class="mdi mdi-reply"></i>BACK</button></a></td>
                                      </tr>
                                      </tbody>
                                    </table>
                                  </div>
