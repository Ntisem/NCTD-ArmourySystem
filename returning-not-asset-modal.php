...
<!-- Returns Asset Modal -->
<div class="modal fade" id="return-asset-<?php echo $row['bookAssetID'];?>&<?php echo $row['officerID'];?>" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-light btn-fw" name="not-returning-asset">Submit</button>
      </div>
      </form>
    </div>
  </div>
