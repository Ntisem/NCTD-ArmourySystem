          ...
          <!-- End of fetching of data -->
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                          <form method="POST" action="process-weapon-update.php" class="forms-sample" enctype="multipart/form-data">
                          <?php  
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <select name="firearm_caliber" class="form-control">
                                <option value="<?php echo $firearm_caliber ?>"><?php echo $firearm_caliber ?></option>
