...
<head>
    ...
    <title>Reset Code Password | GPS ARMORY SYSTEM</title>
                    ...
                    <div class="authentication-form mx-auto">
                        ...
                        <form action="reset-code.php" method="POST" autocomplete="off">
                            <div class="form-group">
                                <input type="number" name="otp" class="form-control" placeholder="Enter Code" required="">
                                <!-- <input type="hidden" name="token" value=""> -->
                                <i class="ik ik-mail"></i>
                            </div>
                            <div class="sign-btn text-center">
                                <button type="submit" name="check-reset-otp" class="btn" style="background-color: #ffa600; color:#fff;">Submit Code</button>
