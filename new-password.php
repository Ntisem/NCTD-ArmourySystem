...
<body>
            ...
            <div class="row flex-row h-100 bg-white">
                ...
                <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                    <div class="authentication-form mx-auto">
                        ...
                        <h3 style="font-weight: 10000" ><strong>CREATE NEW PASSWORD</strong></h3>    
                        <?php 
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group ">
                                <input type="password" name="cpassword"  id="c_password" class="form-control" placeholder=" Confirm Password"
                                    value="" required>
                                <i class="ik ik-lock"></i>
    ...
    let c_eye_icon = document.getElementById("c_eye_icon");
    ...
    c_eye_icon.onclick = function(){
        if(password.type == "password"){
        c_password.type = "text";
        c_eye_icon.src = "assets/images/password_images/eye-open.png";
        }else{
        c_password.type = "password";
        c_eye_icon.src = "assets/images/password_images/eye-close.png";
        }
