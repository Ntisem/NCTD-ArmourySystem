...
<!-- Returns Modal -->
<div class="modal fade" id="return-booking-officer-<?php echo $row['bookingID'];?>" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="functions.php" enctype="multi">
        <div class="form-group">
        <h5 class="modal-title" id="exampleModalLabel"><code style="color:#fff;">
            Officer: </code><code style="color:#fff;"><?php echo $row['to_officer']; ?></code></h5>
        <br>
        <h5 class="modal-title" id="exampleModalLabel"><code style="color:#fff;">Firearm: 
        </code><code style="color:#fff;"><?php echo $row['firearm_name'].' ['.$row['number_of_rounds'].']' ?></code></h5>
        <br>
        <label for="returns" style="color:#fff;"><code style="color:#fff;">Firearm Returning</code></label>
        <div class="col-sm-9">
        <select class="form-control" name="returns">
        <option value="<?php echo $row['returns']; ?>"><?php echo $row['returns']; ?></option>
        ...
        <br>
        <div class="form-group">
        <label for="returns" style="color:#fff;"><code style="color:#fff;">Firearm State</code></label>
        <div class="col-sm-9">
        <select class="form-control" name="firearm_state">
        <option value="<?php echo $row['firearm_state']; ?>"><?php echo $row['firearm_state']; ?></option>
        <option value="Not-Faulty">Not Faulty</option>
        <option value="Faulty">Faulty</option>
        </select>
        </div> 
        <div class="form-group">
        <label><code style="color:#fff;"> Ammunition Count/Returned</code></label>
        <input type="number" class="form-control" name="ammo_returned" id="ammo_returned" 
            placeholder="Ammo Returning">
        </div>
        <br>
        <div class="form-group">
        ...
        <input type="hidden" name="number_of_rounds" value="<?php echo $row['number_of_rounds']; ?>">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-light btn-fw" name="returning-firearm-officer">Submit</button>
      </div>
      </form>
    </div>
  </div>
...
<!-- Returns Asset Modal -->
<div class="modal fade" id="return-asset-officer-<?php echo $row['bookAssetID'];?>" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger btn-fw" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-light btn-fw" name="returning-asset-officer">Submit</button>
      </div>
      </form>
    </div>
  </div>
