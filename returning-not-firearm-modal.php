...
<!-- Returns Modal -->
<div class="modal fade" id="return-booking-<?php echo $row['bookingID'];?>&<?php echo $row['officerID'];?>" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="functions.php" enctype="multi">
        ...
        <br>
        <div class="form-group">
        <label for="returns"><code style="color:#fff;">Firearm Returning</code></label>
        <div class="col-sm-9">
        ...
        <br>
        <div class="form-group">
        <label for="returns"><code style="color:#fff;">Firearm State</code></label>
        <div class="col-sm-9">
        ...
        <input type="hidden" name="duty_duration" value="<?php echo $row['duty_duration']; ?>">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-light btn-fw" name="not-returning-firearm">Submit</button>
        </div>
      </form>
    </div>
  </div>
