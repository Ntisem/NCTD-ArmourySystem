        ...
        <div class="main-panel">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
              <p class="card-description"><a href="booking-ammo"><code><i class="mdi mdi-plus f-22 text-green"></i><i class="mdi mdi-book f-22 text-green" 
                ...
                <thead>
                     ...
                     <?php
                      ...
                      while ($row = mysqli_fetch_array($query)) {
                         ...
                         $query = mysqli_query($connect_db,"SELECT * FROM `ammo_bookings` ORDER BY `book_ammoID` DESC")
                          ...
                          while ($row = mysqli_fetch_array($query)) {
                            ...
                            <td>
                            <a href="#return-ammo-'.$row['book_ammoID'].'"  
                            data-toggle="modal" class="badge badge-outline-primary" style="padding-top:6px;text-decoration:none;"> '.$row['ammo_returns'].' </a>         
                            </td>
                          ...
                          <img src="assets/images/officer_images/'.$row['officer_image'].'" alt="image" />&nbsp; &nbsp; '.$row['to_officer'].'</a> 
                           ...
                           <td>'.$row['ammo_name'].'</td>
                           <td><code>[BAR: '.$row['ammo_rounds'].' ]&nbsp;</code> <code style="color:orange">[RAR: '.$row['ammo_returned'].']</code></td>
                          <td> '.$row['ammo_comment'].'</td>
                          <td>
                          <a href="#" 
                            class="badge badge-outline-success" style="padding-top:6px;text-decoration:none;"> '.$row['ammo_returns'].' </a>   
                          </td>
                          <td> 
                          <a href="update-ammo-booking?ammo-booking-ticket='.$row['book_ammoID'].'"><i class="mdi mdi-playlist-edit f-16 mr-15 text-green"></i></a>
