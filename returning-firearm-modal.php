...
<!-- Returns Modal -->
<div class="modal fade" id="return-booking-<?php echo $row['bookingID'];?>" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="functions.php" enctype="multi">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-light btn-fw" name="returning-firearm">Submit</button>
        </div>
      </form>
    </div>
  </div>
