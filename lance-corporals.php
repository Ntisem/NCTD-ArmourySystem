        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Officers List - <span style="color: #f9a602;font-weight:600;">LANCE CORPORALS</span> </h3>
                  ...
                  <?php
                      ...
                      while ($row = mysqli_fetch_array($query)) {
                        ...
                        $_SESSION['armourer_admin_name'] = $armourer_admin_name;
                          ...
                          $query = mysqli_query($connect_db,"SELECT * FROM `officers` WHERE `rank`='L/CPL' AND `officer_status`='Active' OR `rank`='L/CPL' AND `officer_status`='Active In Service'  ORDER BY `officerID`  ASC ")
                          or die( mysqli_error($connect_db));
                          while ($row = mysqli_fetch_array($query)) {
                              $output = "";
