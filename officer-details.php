                        ...
                        <div class="col-md-4">
                            <div class="card tactical-card h-100">
                                <div class="card-body text-center">
                                    <?php if (!empty($officer['officer_image']) && file_exists('uploads/' . $officer['officer_image'])): ?>
                                        <img src="uploads/<?= $officer['officer_image'] ?>" width="120" height="120" class="rounded-circle mb-3 border border-info">
                                    <?php else: ?>
